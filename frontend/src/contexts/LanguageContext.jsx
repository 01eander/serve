...
const translations = {
  es: {
    ...
    pin_default_notice: 'Por default la contraseña (PIN) es 1234, puedes cambiarla después.',
    forgot_pin: '¿Olvidaste tu PIN?',
    reset_pin_title: 'Restablecer PIN de Administrador',
    reset_pin_desc: 'Ingresa la contraseña de la empresa para autorizar el cambio de PIN.',
    company_password_label: 'Contraseña de la Empresa',
    new_pin_label: 'Nuevo PIN (4 dígitos)',
    reset_pin_success: '¡PIN restablecido con éxito!',
    invalid_company_password: 'Contraseña de empresa incorrecta',
    reset_to_default_pin: 'Restablecer a 1234',
    show_pin: 'Mostrar PIN',
    ...
    onboarding_step_2_title: '2. Control de Caja (Efectivo)',
    onboarding_step_2_desc: 'Al iniciar tu jornada, entra a Caja para abrir tu turno con un fondo inicial, registrar depósitos/retiros y realizar el corte Z al finalizar.',
    onboarding_step_3_title: '3. Promociones & Ofertas (Versión PRO 👑)',
    ...
    onboarding_skip: 'Omitir guía',
    onboarding_finish: '¡Entendido! Empezar',
    onboarding_restart: 'Guía Virtual',
  ...
  en: {
    ...
    pin_default_notice: 'By default the password (PIN) is 1234, you can change it later.',
    forgot_pin: 'Forgot your PIN?',
    reset_pin_title: 'Reset Admin PIN',
    reset_pin_desc: 'Enter company password to authorize PIN change.',
    company_password_label: 'Company Password',
    new_pin_label: 'New PIN (4 digits)',
    reset_pin_success: 'PIN successfully reset!',
    invalid_company_password: 'Incorrect company password',
    reset_to_default_pin: 'Reset to 1234',
    show_pin: 'Show PIN',
    hide_pin: 'Hide PIN',
    ...
    onboarding_step_2_title: '2. Cash Drawer Control',
    onboarding_step_2_desc: 'At the start of your shift, enter Cash Drawer to open your session with an initial balance, log cash movements and perform Z report at closing.',
    onboarding_step_3_title: '3. Promotions & Offers (PRO Version 👑)',
    ...
    onboarding_finish: 'Got it! Get Started',
    onboarding_restart: 'Virtual Tour',
  ...
  pt: {
    ...
    pin_default_notice: 'Por padrão a senha (PIN) é 1234, você pode alterá-la depois.',
    forgot_pin: 'Esqueceu seu PIN?',
    reset_pin_title: 'Redefinir PIN de Administrador',
    reset_pin_desc: 'Digite a senha da empresa para autorizar a alteração do PIN.',
    company_password_label: 'Senha da Empresa',
    new_pin_label: 'Novo PIN (4 dígitos)',
    reset_pin_success: 'PIN redefinido com sucesso!',
    invalid_company_password: 'Senha da empresa incorreta',
    reset_to_default_pin: 'Redefinir para 1234',
    show_pin: 'Mostrar PIN',
    hide_pin: 'Ocultar PIN',
    ...
    onboarding_step_2_title: '2. Controle de Caixa',
    onboarding_step_2_desc: 'No início do seu turno, acesse o Caixa para abrir a sessão com saldo inicial, registrar movimentações e emitir o relatório Z no fechamento.',
    onboarding_step_3_title: '3. Promoções & Ofertas (Versão PRO 👑)',
    ...
    onboarding_prev: 'Anterior',
    onboarding_skip: 'Pular guia',
    onboarding_finish: 'Entendido! Começar',
    onboarding_restart: 'Guia Virtual',
