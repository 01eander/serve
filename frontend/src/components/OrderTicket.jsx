import { ShoppingCart, MessageSquare, ChefHat, CreditCard, X } from 'lucide-react';
        ...
        <div className="space-y-3">
          {hasUnsentItems ? (
            ...
            <motion.button 
              ...
              onClick={onCheckout}
              disabled={orderItems.length === 0}
              className="w-full bg-gradient-to-r from-primary-600 to-primary-500 hover:from-primary-500 hover:to-primary-400 text-white font-bold py-5 rounded-[1.25rem] shadow-[0_8px_20px_rgba(124,58,237,0.3)] hover:shadow-[0_8px_25px_rgba(124,58,237,0.4)] transition-all flex items-center justify-center space-x-3 disabled:opacity-50 disabled:shadow-none disabled:cursor-not-allowed"
            >
